...
func Test_ConsulKV_Notify(t *testing.T) {
	...
	for _, tc := range cases {
		t.Run(tc.name, func(t *testing.T) {
			...
			n := ConsulKV{Template: tmpl, once: true}
...
func Test_ConsulKV_Notify_Once_Mode(t *testing.T) {
	cases := []struct {
		name string
		dep  interface{}
	}{
	...
	for _, tc := range cases {
		t.Run("services-last-with-"+tc.name, func(t *testing.T) {
		...
		t.Run("consul-kv-last-with"+tc.name, func(t *testing.T) {
